<template>
  <main>
    <div v-if="store.calculations.length == 0" style="padding: 0 5em 0 5em">
      <WelcomePage @start="addCalculation()" />
    </div>
    <div v-else>
      <div class="header-container">
        <h1>
          ...
          <el-dropdown>
            <el-button class="button" text> ⚙️ </el-button>
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item @click="editCalculation()">
                  Edit
                </el-dropdown-item>
                <el-dropdown-item @click="removeCalculation()" divided>
                  Remove
                </el-dropdown-item>
              </el-dropdown-menu>
            </template>
        ...
        <div class="right-content">
          ...
          <el-dropdown>
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <div
                  v-for="(calculation, index) in this.store.calculations"
                  :key="calculation.pk"
                >
                  <el-dropdown-item @click="changeCalculation(index)">
                    {{ calculation.name }}</el-dropdown-item
                  >
                </div>
      ...
      <div
        v-for="(used_component, index) in this.store.components_use"
        :key="used_component.pk"
      >
        <div class="use-card">
          <el-card>
            <div style="float: right">
              <el-dropdown>
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item @click="changeComponent(index)"
                      >Cambiar componente</el-dropdown-item
                    >
                    <el-dropdown-item
                      @click="editComponent(used_component, index)"
                      >Editar componente</el-dropdown-item
                    >
                    <el-dropdown-item
                      @click="removeUsedComponent(index)"
                      divided
                      >Eliminar uso</el-dropdown-item
                    >
                  </el-dropdown-menu>
                </template>
              </el-dropdown>
    ...
    <el-dialog
      v-model="dialogComponentVisible"
      title="Add component"
      width="600px"
    >
      <el-scrollbar height="400px" style="width: auto">
        <div
          v-for="(component, index) in this.store.components.system"
          :key="component.pk"
        >
          ...
          <div v-if="!store.components_is_used.system[index]">
            <el-card
              @click="saveComponent(component.system_component, index)"
              disabled=""
              class="box-card"
              el-card
              shadow="hover"
        ...
        <div
          v-for="(component, index) in this.store.components.user"
          :key="component.pk"
          style="width: auto"
        >
    ...
    >
      ...
      />
      <el-alert v-else type="info alert">
        Este componente no puede editarse directamente, cuando guardes se creará
        una copia en el apartado <b>tus componentes</b>
      </el-alert>
...
//import ComponentColapse from "@/components/calculator/ComponentColapse.vue"
...
const WelcomePage = defineAsyncComponent({
  loader: () => import('@/components/Welcome.vue'),
  loadingComponent: LoadingC,
  delay: 0,
  timeout: 3000
})
