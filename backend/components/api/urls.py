...
from .viewsets import ComponentViewSet, CalculationDetailAPIView, CalculationListCreateAPIView
...
urlpatterns = [
        ...
        path("calculation/<calc_pk>/usage", ComponentUsageListCreateAPIView.as_view(), name="usage-list"),
